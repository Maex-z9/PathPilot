...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <done>
    User confirms: Real PoE sprites render correctly (all node types), active/inactive distinction clear, group backgrounds visible, LOD switching works, all interactions unchanged.
  </done>
</task>
