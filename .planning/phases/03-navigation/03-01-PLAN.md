...
<task type="auto">
  ...
  <action>
Add zoom and pan navigation to SkillTreeCanvas by implementing Avalonia pointer event overrides.
...
Build succeeds: `dotnet build src/PathPilot.Desktop/PathPilot.Desktop.csproj`
  ...
  <done>
SkillTreeCanvas has OnPointerWheelChanged, OnPointerPressed, OnPointerMoved, OnPointerReleased overrides. SkillTreeDrawOperation applies offset transformation.
  </done>
</task>
